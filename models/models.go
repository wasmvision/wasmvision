...
var KnownModels = map[string]ModelFile{
	"candy-9": {
		...
		URL:         "https://huggingface.co/onnxmodelzoo/legacy_models/resolve/main/validated/vision/style_transfer/fast_neural_style/model/candy-9.onnx",
		Description: "Candy model for fast neural style transfer (opset 8)",
	},
	"candy-8": {
		Alias:       "candy-8",
		Filename:    "candy-8.onnx",
		URL:         "https://huggingface.co/onnxmodelzoo/legacy_models/resolve/main/validated/vision/style_transfer/fast_neural_style/model/candy-8.onnx",
		Description: "Candy model for fast neural style transfer (opset 8)",
	},
	"mosaic-9": {
		Alias:       "mosaic-9",
		Filename:    "mosaic-9.onnx",
		URL:         "https://huggingface.co/onnxmodelzoo/legacy_models/resolve/main/validated/vision/style_transfer/fast_neural_style/model/mosaic-9.onnx",
		Description: "Mosaic model for fast neural style transfer (opset 9)",
	},
	"mosaic-8": {
		Alias:       "mosaic-8",
		Filename:    "mosaic-8.onnx",
		URL:         "https://huggingface.co/onnxmodelzoo/legacy_models/resolve/main/validated/vision/style_transfer/fast_neural_style/model/mosaic-8.onnx",
		Description: "Mosaic model for fast neural style transfer (opset 8)",
	},
	"pointilism-9": {
		Alias:       "pointilism-9",
		Filename:    "pointilism-9.onnx",
		URL:         "https://huggingface.co/onnxmodelzoo/legacy_models/resolve/main/validated/vision/style_transfer/fast_neural_style/model/pointilism-9.onnx",
		Description: "Pointilism model for fast neural style transfer (opset 9)",
	},
	"pointilism-8": {
		Alias:       "pointilism-8",
		Filename:    "pointilism-8.onnx",
		URL:         "https://huggingface.co/onnxmodelzoo/legacy_models/resolve/main/validated/vision/style_transfer/fast_neural_style/model/pointilism-8.onnx",
		Description: "Pointilism model for fast neural style transfer (opset 8)",
	},
	"rain-princess-9": {
		Alias:       "rain-princess-9",
		Filename:    "rain-princess-9.onnx",
		URL:         "https://huggingface.co/onnxmodelzoo/legacy_models/resolve/main/validated/vision/style_transfer/fast_neural_style/model/rain-princess-9.onnx",
		Description: "Rain Princess model for fast neural style transfer (opset 9)",
	},
	"rain-princess-8": {
		Alias:       "rain-princess-8",
		Filename:    "rain-princess-8.onnx",
		URL:         "https://huggingface.co/onnxmodelzoo/legacy_models/resolve/main/validated/vision/style_transfer/fast_neural_style/model/rain-princess-8.onnx",
		Description: "Rain Princess model for fast neural style transfer (opset 8)",
	},
	"udnie-9": {
		Alias:       "udnie-9",
		Filename:    "udnie-9.onnx",
		URL:         "https://huggingface.co/onnxmodelzoo/legacy_models/resolve/main/validated/vision/style_transfer/fast_neural_style/model/udnie-9.onnx",
		Description: "Udnie model for fast neural style transfer (opset 9)",
	},
	"udnie-8": {
		Alias:       "udnie-8",
		Filename:    "udnie-8.onnx",
		URL:         "https://huggingface.co/onnxmodelzoo/legacy_models/resolve/main/validated/vision/style_transfer/fast_neural_style/model/udnie-8.onnx",
	...
	"mobilefacenet_2022july": {
		...
		URL:         "https://huggingface.co/opencv/facial_expression_recognition/resolve/main/facial_expression_recognition_mobilefacenet_2022july.onnx",
	...
	"mobilefacenet_2022july_int8bq": {
		...
		URL:         "https://huggingface.co/opencv/facial_expression_recognition/resolve/main/facial_expression_recognition_mobilefacenet_2022july_int8bq.onnx",
	...
	"Qwen2.5-VL-3B-Instruct-Q8_0": {
		...
		Description: "Qwen2.5-VL 3B vision language text model",
	},
	"mmproj-Qwen2.5-VL-3B-Instruct-Q8_0": {
		...
		Description: "Qwen2.5-VL 3B vision language projector model",
	},
	...
	"Qwen2.5-VL-7B-Instruct-Q8_0": {
		Alias:       "Qwen2.5-VL-7B-Instruct-Q8_0",
		Filename:    "Qwen2.5-VL-7B-Instruct-Q8_0.gguf",
		URL:         "https://huggingface.co/ggml-org/Qwen2.5-VL-7B-Instruct-GGUF/resolve/main/Qwen2.5-VL-7B-Instruct-Q8_0.gguf",
		Description: "Qwen2.5-VL 7B vision language text model",
	},
	"mmproj-Qwen2.5-VL-7B-Instruct-Q8_0": {
		Alias:       "mmproj-Qwen2.5-VL-7B-Instruct-Q8_0",
		...
		Description: "Qwen2.5-VL 7B vision language projector model",
	},
	"SmolVLM-256M-Instruct-Q8_0": {
		Alias:       "SmolVLM-256M-Instruct-Q8_0",
		Filename:    "SmolVLM-256M-Instruct-Q8_0.gguf",
		URL:         "https://huggingface.co/ggml-org/SmolVLM-256M-Instruct-GGUF/resolve/main/SmolVLM-256M-Instruct-Q8_0.gguf",
		Description: "SmolVLM-256M-Instruct vision language text model",
	},
	"mmproj-SmolVLM-256M-Instruct-Q8_0": {
		Alias:       "mmproj-SmolVLM-256M-Instruct-Q8_0",
		...
		Description: "SmolVLM-256M-Instruct vision language projector model",
	},
	"SmolVLM-256M-Instruct-f16": {
		Alias:       "SmolVLM-256M-Instruct-f16",
		Filename:    "SmolVLM-256M-Instruct-f16.gguf",
		URL:         "https://huggingface.co/ggml-org/SmolVLM-256M-Instruct-GGUF/resolve/main/SmolVLM-256M-Instruct-f16.gguf",
		Description: "SmolVLM-256M-Instruct vision language text model",
	},
	"mmproj-SmolVLM-256M-Instruct-f16": {
		Alias:       "mmproj-SmolVLM-256M-Instruct-f16",
	...
	"SmolVLM-500M-Instruct-Q8_0": {
		Alias:       "SmolVLM-500M-Instruct-Q8_0",
		Filename:    "SmolVLM-500M-Instruct-Q8_0.gguf",
		URL:         "https://huggingface.co/ggml-org/SmolVLM-500M-Instruct-GGUF/resolve/main/SmolVLM-500M-Instruct-Q8_0.gguf",
		Description: "SmolVLM-500M-Instruct vision language text model",
	},
	"mmproj-SmolVLM-500M-Instruct-Q8_0": {
		Alias:       "mmproj-SmolVLM-500M-Instruct-Q8_0",
		...
		Description: "SmolVLM-500M-Instruct vision language projector model",
	},
	"SmolVLM-500M-Instruct-f16": {
		Alias:       "SmolVLM-500M-Instruct-f16",
		Filename:    "SmolVLM-500M-Instruct-f16.gguf",
		URL:         "https://huggingface.co/ggml-org/SmolVLM-500M-Instruct-GGUF/resolve/main/SmolVLM-500M-Instruct-f16.gguf",
		Description: "SmolVLM-500M-Instruct vision language text model",
	},
	"mmproj-SmolVLM-500M-Instruct-f16": {
		Alias:       "mmproj-SmolVLM-500M-Instruct-f16",
	...
	"SmolVLM2-256M-Video-Instruct-Q8_0": {
		Alias:       "SmolVLM2-256M-Video-Instruct-Q8_0",
		...
		Description: "SmolVLM2-256M-Video-Instruct vision language text model",
	},
	"mmproj-SmolVLM2-256M-Video-Instruct-Q8_0": {
		Alias:       "mmproj-SmolVLM2-256M-Video-Instruct-Q8_0",
		...
		Description: "SmolVLM2-256M-Video-Instruct vision language projector model",
	},
	"SmolVLM2-256M-Video-Instruct-f16": {
		Alias:       "SmolVLM2-256M-Video-Instruct-f16",
		Filename:    "SmolVLM2-256M-Video-Instruct-f16.gguf",
		URL:         "https://huggingface.co/ggml-org/SmolVLM2-256M-Video-Instruct-GGUF/resolve/main/SmolVLM2-256M-Video-Instruct-f16.gguf",
		Description: "SmolVLM2-256M-Video-Instruct vision language text model",
	},
	"mmproj-SmolVLM2-256M-Video-Instruct-f16": {
		Alias:       "mmproj-SmolVLM2-256M-Video-Instruct-f16",
		Filename:    "mmproj-SmolVLM2-256M-Video-Instruct-f16.gguf",
		URL:         "https://huggingface.co/ggml-org/SmolVLM2-256M-Video-Instruct-GGUF/resolve/main/mmproj-SmolVLM2-256M-Video-Instruct-f16.gguf",
		Description: "SmolVLM2-256M-Video-Instruct vision language projector model",
	},
	"SmolVLM2-500M-Video-Instruct-Q8_0": {
		Alias:       "SmolVLM2-500M-Video-Instruct-Q8_0",
		...
		Description: "SmolVLM2-500M-Video-Instruct vision language text model",
	},
	"mmproj-SmolVLM2-500M-Video-Instruct-Q8_0": {
		Alias:       "mmproj-SmolVLM2-500M-Video-Instruct-Q8_0",
		...
		Description: "SmolVLM2-500M-Video-Instruct vision language projector model",
	},
	"SmolVLM2-500M-Video-Instruct-f16": {
		Alias:       "SmolVLM2-500M-Video-Instruct-f16",
	...
	"mmproj-SmolVLM2-500M-Video-Instruct-f16": {
		Alias:       "mmproj-SmolVLM2-500M-Video-Instruct-f16",
	...
	"SmolVLM2-2.2B-Instruct-Q8_0": {
		Alias:       "SmolVLM2-2.2B-Instruct-Q8_0",
		...
		Description: "SmolVLM2-2.2B-Instruct vision language text model",
	},
	"mmproj-SmolVLM2-2.2B-Instruct-Q8_0": {
		Alias:       "mmproj-SmolVLM2-2.2B-Instruct-Q8_0",
		...
		Description: "SmolVLM2-2.2B-Instruct vision language projector model",
	},
	"InternVL3-1B-Instruct-Q8_0": {
		Alias:       "InternVL3-1B-Instruct-Q8_0",
		Filename:    "InternVL3-1B-Instruct-Q8_0.gguf",
		URL:         "https://huggingface.co/ggml-org/InternVL3-1B-Instruct-GGUF/resolve/main/InternVL3-1B-Instruct-Q8_0.gguf",
		Description: "InternVL3-1B-Instruct vision language text model",
	},
	"mmproj-InternVL3-1B-Instruct-Q8_0": {
		Alias:       "mmproj-InternVL3-1B-Instruct-Q8_0",
		Filename:    "mmproj-InternVL3-1B-Instruct-Q8_0.gguf",
		URL:         "https://huggingface.co/ggml-org/InternVL3-1B-Instruct-GGUF/resolve/main/mmproj-InternVL3-1B-Instruct-Q8_0.gguf",
		Description: "InternVL3-1B-Instruct vision language projector model",
	},
	"InternVL3-1B-Instruct-f16": {
		Alias:       "InternVL3-1B-Instruct-f16",
		Filename:    "InternVL3-1B-Instruct-f16.gguf",
		URL:         "https://huggingface.co/ggml-org/InternVL3-1B-Instruct-GGUF/resolve/main/InternVL3-1B-Instruct-f16.gguf",
		Description: "InternVL3-1B-Instruct vision language text model",
	},
	"mmproj-InternVL3-1B-Instruct-f16": {
		Alias:       "mmproj-InternVL3-1B-Instruct-f16",
		Filename:    "mmproj-InternVL3-1B-Instruct-f16.gguf",
		URL:         "https://huggingface.co/ggml-org/InternVL3-1B-Instruct-GGUF/resolve/main/mmproj-InternVL3-1B-Instruct-f16.gguf",
		Description: "InternVL3-1B-Instruct vision language projector model",
	},
	"InternVL3-2B-Instruct-Q8_0": {
		Alias:       "InternVL3-2B-Instruct-Q8_0",
		Filename:    "InternVL3-2B-Instruct-Q8_0.gguf",
		URL:         "https://huggingface.co/ggml-org/InternVL3-2B-Instruct-GGUF/resolve/main/InternVL3-2B-Instruct-Q8_0.gguf",
		Description: "InternVL3-2B-Instruct vision language text model",
	},
	"mmproj-InternVL3-2B-Instruct-Q8_0": {
		Alias:       "mmproj-InternVL3-2B-Instruct-Q8_0",
		Filename:    "mmproj-InternVL3-2B-Instruct-Q8_0.gguf",
		URL:         "https://huggingface.co/ggml-org/InternVL3-2B-Instruct-GGUF/resolve/main/mmproj-InternVL3-2B-Instruct-Q8_0.gguf",
		Description: "InternVL3-2B-Instruct vision language projector model",
	},
	"InternVL3-2B-Instruct-f16": {
		Alias:       "InternVL3-2B-Instruct-f16",
		Filename:    "InternVL3-2B-Instruct-f16.gguf",
		URL:         "https://huggingface.co/ggml-org/InternVL3-2B-Instruct-GGUF/resolve/main/InternVL3-2B-Instruct-f16.gguf",
		Description: "InternVL3-2B-Instruct vision language text model",
	},
	"mmproj-InternVL3-2B-Instruct-f16": {
		Alias:       "mmproj-InternVL3-2B-Instruct-f16",
		Filename:    "mmproj-InternVL3-2B-Instruct-f16.gguf",
		URL:         "https://huggingface.co/ggml-org/InternVL3-2B-Instruct-GGUF/resolve/main/mmproj-InternVL3-2B-Instruct-f16.gguf",
		Description: "InternVL3-2B-Instruct vision language projector model",
	},
	"gemma-3-4b-it-qat-Q4_0": {
		...
		Description: "Gemma 3 4B it-qat vision language text model",
	},
	"mmproj-gemma-model-f16-4B": {
		Alias:       "mmproj-gemma-model-f16-4B",
		Filename:    "mmproj-model-f16-4B.gguf",
		URL:         "https://huggingface.co/ggml-org/gemma-3-4b-it-qat-GGUF/resolve/main/mmproj-model-f16-4B.gguf",
		Description: "Gemma 3 4B it-qat vision language projector model",
	},
	"moondream2-text-model-f16_ct-vicuna": {
		Alias:       "moondream2-text-model-f16_ct-vicuna",
		...
		Description: "Moondream 2 vision language text model",
	},
	"moondream2-mmproj-f16-20250414": {
		Alias:       "moondream2-mmproj-f16-20250414",
		...
		Description: "Moondream 2 vision language projector model",
	},
}
